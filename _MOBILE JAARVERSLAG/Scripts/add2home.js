...
var nav = navigator,
	...
	options = {
		...
		lifespan: 15000,			// 20 seconds before it is automatically destroyed
		bottomOffset: 14,			// Distance of the balloon from bottom
		expire: 2000000,				// Minutes to wait before showing the popup again (0 = always displayed)
...
intl = {
		...
		en_us: 'Install this  %device app!<br />Tap %icon then click:<br /><strong>Add to Home Screen</strong>',
...
function loaded () {
	...
	setTimeout(function () {
		...
		el.style.left = isIPad ? startX + 158 - Math.round(el.offsetWidth/2) + 'px' : startX + 'px';
